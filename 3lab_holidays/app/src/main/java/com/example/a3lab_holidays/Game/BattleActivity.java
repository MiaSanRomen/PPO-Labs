...
import com.example.a3lab_holidays.MainActivity;
import com.example.a3lab_holidays.MenuActivity;
...
import com.example.a3lab_holidays.UserHelper;
...
public class BattleActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private final Button[][] ebuttons = new Button[8][8];
    private final boolean[][] isDisabled = new boolean[8][8];
    Button finish;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < 8; i++) {
            for (int j = 0; j < 8; j++) {
                ...
                ebuttons[i][j].setBackgroundColor(Color.BLUE);
                ebuttons[i][j].setText(buttonID);
                ebuttons[i][j].setTextColor(Color.BLUE);
    ...
    public void checkWin(){
        if(targets.isEmpty()){
            ...
            DatabaseReference refUsers = FirebaseDatabase.getInstance("https://lab-holidays-default-rtdb.firebaseio.com/").getReference("users");
